...
const allRoutes = [
    ...
    { id: 2, path: '/products', name: "Products", faName: "محصولات", component: <LazyProductsPage /> },
    { id: 3, path: '/test', name: "Test", faName: "تست", component: <LazyTestPage /> },
    ...
    return (
        <Routes>
            ...
            <Route
                path="*"
                element={
                    <div className="bg-slate-200 flex justify-center items-center text-3xl w-full h-screen">
                        404 Not Found
                    </div>
                }
            />
